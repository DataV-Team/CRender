import { StyleConfig, LineCap, LineJoin, HoverCursor, FontStyle, FontVarient, FontWeight, TextAlign, TextBaseLine, GradientType, GradientParams, GradientWith, GradientStops, colors } from '../types/core/style';
