...
export default class Graph<Shape = any> {
    ...
    static mergeDefaultShape<Shape>(defaultShape: Shape, config: GraphConfig<Optional<Shape>>, checker?: (config: GraphConfig<Shape>) => void): GraphConfig<Shape>;
    private checkRender;
    /**
     * @description Update graph attribute
     */
    attr(key: keyof GraphConfig<Shape>, value: Optional<GraphConfig<Shape>[typeof key]>, reDraw?: boolean): void;
    /**
