var dev = (function (React, ReactDOM) {
    ...
    ***************************************************************************** */
    ...
    var Graph = /** @class */ (function () {
         ...
         */
        // eslint-disable-next-line
        Graph.prototype.setGraphCenter = function () { };
        /**
    ...
    ***************************************************************************** */
    ...
    var Dev = function () {
        ...
        var renderTest = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
            var render, _a, w, h, circle;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        render = new CRender(canvas.current);
                        _a = render.area, w = _a[0], h = _a[1];
                        circle = render.add({
                            name: 'circle',
                            shape: {},
                        });
                        new Array(1000).fill(0).map(function (_) {
                            return render.add({
                                name: 'circle',
                        ...
                        return [4 /*yield*/, render.drawAllGraph()];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
